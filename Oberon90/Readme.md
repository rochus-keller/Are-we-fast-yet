...
NOTE: this is work in progress, not all benchmarks are migrated yet (Havlak, Json and Deltablue are missing)
...
NBody and Towers had an issue which made them crash on V4. With my ActiveOberon transpiler, Tower didn't crash, and I was able to fix NBody.

See the Results directory for V4 performance measurement results.
